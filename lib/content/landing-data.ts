  ...
  features: {
    ...
    features: [
      ...
      },
      {
        ...
        description: "Optimized for Core Web Vitals with sub-2 second load times. Fast pages mean better SEO and higher conversions.",
        icon: "rocket",
        order: 4,
      },
      {
        ...
        description: "Track conversions and user behavior with built-in analytics support. Make data-driven decisions to optimize your funnel.",
        icon: "chart",
        order: 5,
      },
      {
